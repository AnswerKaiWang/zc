...
<div class="main">
  ...
  <div class="queryPage_Right">
    ...
    <div class="ResultBox">
    <table border="0" cellspacing="0" id="rows2" cellpadding="0" class="table_2">
      <tr>
 ...
 <script type="text/javascript">
    ...
    function addRow(row){
        ...
        +'<td width="100" align="center">'+(row.okTime || "")+'</td>'
        +'<td width="100" align="center">'+(row.fundAccountMoney || "")+'</td>'
