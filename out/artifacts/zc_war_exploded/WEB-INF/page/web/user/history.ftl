...
<head>
<meta charset="utf-8">
<title>历史投资-投资明细-个人中心-[@coAttr name="webSiteName" /]</title>
...
<div class="main">
  <div class="inner_wrap">
    <div class="user_L">
      ...
      <div class="l_menu">
          ...
          <li><a href="#" class="aone">当前投资<i></i></a>
           ...
           <li class="active"><a href="#" class="aone active">历史投资<i></i></a>
            <ol>
              <li>
              <a href="${base}/user/collect.htm?type=history">投资汇总</a>
              <a href="${base}/user/history.htm" class="active">投资明细</a>
    ...
    <div class="user_R">
      ...
      <div class="tz_sc">
      	<form action="${base}/user/history.htm" onkeydown="if(event.keyCode==13)return false;" method="post" id="currentForm">
