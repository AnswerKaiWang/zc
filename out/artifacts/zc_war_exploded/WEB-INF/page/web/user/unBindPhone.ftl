...
<head>
<meta charset="utf-8">
<title>认证原手机号-安全中心-个人中心-[@coAttr name="webSiteName" /]</title>
...
<div class="position_title">
	<div class="wrap"><span>会员中心</span><a href="${base}/index.htm">首页</a>/<a href="${base}/user/center.htm">会员中心</a>/<a href="${base}/user/protect.htm">安全中心</a>/<a href="#" class="active">认证原手机号</a></div>
</div>
<!-- main s -->
<div class="main">
  <div class="inner_wrap">
    ...
    <div class="user_R">
      ...
      <h3 class="r_ty_title_2"><a class="back" href="${base}/user/protect.htm"><img src="${base}/front/images/nsd.jpg" height="12" alt=""></a>认证原手机号</h3>
      <div class="change_mail">
        ...
        <form action="">
        	...
        	<p class="pp2"><i class="fl">认证原手机号</i><i class="fr">绑定新手机号</i></p>
        	<ul class="ul_2">
        		<li><label>手机号码</label><input type="text" class="ipt1" value="${(user.phone)!}" disabled="disabled"></li>
        ...
        <div style="width:450px;margin:auto;text-align:center;">如无法验证原手机，请联系客服协助更改</div>
      </div> 
    </div>
  </div>
</div>
...
<script>
	...
	$("#getCodeButton").click(function(){
		...
		type:"post",
		data:{},
		url:"${base}/user/phone/getCode.htm",
		dataType:"json",
	...
	function subForm(){
		...
		type:"post",
		data:{code:$("#code").val()},
		url:"${base}/user/phone/unBind.htm",
		dataType:"json",
		success:function(data){
			if(data.status=="00"){
				top.location.href="${base}/user/phone/toBind.htm";
			}else{
				$("#sendMsgSuccess").html(data.status);
