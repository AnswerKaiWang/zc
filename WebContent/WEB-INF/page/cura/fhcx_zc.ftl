...
<div class="main">
  ...
  <div class="queryPage_Right">
    ...
    <table border="0" cellspacing="0" id="rows" cellpadding="0" class="table_3">
      <tr>
        ...
        <th width="110" align="center">认购人户名</th>
        <th width="200" align="center">详情</th>
        </tr>
    </table>
    </div>
  ...
  <script type="text/javascript">
    ...
    function addRow(row){
        ...
        +'<td width="110" align="center">'+(row.buyUserName || "")+'</td>'
    ...
    function toPD(id){
    	window.document.location = "${base}/cura/cust/share/detail.htm?id="+id;
    }
</script>
  <!-- queryPage_Right e -->
</div>
