...
<head>
<meta charset="utf-8">
<title>邮箱绑定-安全中心-个人中心-[@coAttr name="webSiteName" /]</title>
...
<div class="position_title">
	<div class="wrap"><span>会员中心</span><a href="${base}/index.htm">首页</a>/<a href="${base}/user/center.htm">会员中心</a>/<a href="${base}/user/protect.htm">安全中心</a>/<a href="#" class="active">绑定新邮箱</a></div>
</div>
<!-- main s -->
<div class="main">
  <div class="inner_wrap">
    ...
    <div class="user_R">
      ...
      <h3 class="r_ty_title_2"><a class="back" href="${base}/user/protect.htm"><img src="${base}/front/images/nsd.jpg" height="12" alt=""></a>绑定新邮箱</h3>
      <div class="change_mail">
      	<div style="width:450px;margin:auto;color:red;text-align:center;" id="sendMsgSuccess">${(info)!}</div>
        <form action="">
        	<ul class="ul_2">
        		<li><label>邮箱绑定</label><input type="text" class="ipt1" value="" id="email"></li>
        		<li><label>验证码</label><input type="text" class="ipt1" placeholder="请输入邮箱验证码" id="code"><a href="#" class="get" id="getCodeButton">获取</a></li>
...
<script>
	...
	$("#getCodeButton").click(function(){
		...
		url:"${base}/user/email/getCode.htm?smsType=bindEmail",
		dataType:"json",
